...
\begin{itemize}
    \item TrafficOptimizationEngine received data only from TrafficAnalyzer, the latter has the logic to encapsulate the right data while the optimizationEngine is only a compunting component that expect data in a particular format.
