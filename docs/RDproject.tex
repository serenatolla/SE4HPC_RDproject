...
is the same.
\newline Here the TrafficAnalyzer have the same connections with PTScheduleMicroservice and Sensors Bus, but for redundancy reasons as been hide.
\begin{figure}[h]
    \centering
...
\end{itemize}
\subsection*{TODO - critical aspects:}
\begin{itemize}
